...
#pragma endregion
	...
	template <SoLib::IsRealType... Ts>
	inline void ShaderEffectProcessor::Execute(const std::wstring &psName, SolEngine::FullScreenTexture *const source, const CBuffer<Ts> &...args)
	{
...
#pragma endregion
		...
		command->SetGraphicsRootDescriptorTable(1, source->srvHandle_.gpuHandle_);
